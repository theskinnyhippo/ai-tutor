// only the minimal fix: move the “no plans” paragraph out of .map()
"use client";
  ...
  return (
    <div className="flex-1 py-4 px-4 md:px-8 flex flex-col gap-y-10">
      <div className="mt-4 flex-1 flex flex-col gap-y-10 items-center">
        <h5 className="font-medium text-2xl md:text-3xl text-gray-500">
          You are on the{" "}
...
export const UpgradeViewLoading = () => (
  <LoadingState title="Loading" description="Wait up..." />
);
